    ...
    return (
        <div className="app">
            <div className="flex justify-between px-4 py-3 border-b w-full confirm-container">
                <div className='w-3 h-3 border-2 border-transparent border-l-blue border-t-blue -rotate-45 m-1.5 shrink-0'></div>
                <h1 className="text-lg font-medium text-blue text-center">Подтверждение заказа</h1>
            </div>
            <div className="flex flex-col h-full w-full px-4 py-6 overflow-y-auto font-normal text-lg text-blue confirm-container">
                ...
                <div className='flex justify-between w-full p-4 rounded-2xl mb-8 bg-bej '>
                    ...
                    <div className='w-3 h-3 border-2 border-transparent border-r-blue border-t-blue rotate-45 m-1.5 shrink-0'></div>
                </div>
                ...
                <button
                    className="bg-pink text-white border border-pink rounded-2xl py-4 mb-6 order-button"
                >
                    Оплатить заказ
                </button>
