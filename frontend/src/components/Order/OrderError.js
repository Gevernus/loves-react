    ...
    return (
        <div className="app">
            <div className="px-4 py-3 border-b w-full">
                <h1 className="text-lg font-medium text-blue text-center">Моя корзина</h1>
            </div>
            <div className="flex flex-col items-center h-full px-4 py-6  order-container">
                <div className='flex flex-col flex-auto justify-center items-center'>
                    ...
                    />
                    <p className='font-medium text-2xl text-center text-blue'>Что-то пошло не так :(</p>
                ...
                <button
                    className="bg-pink text-white rounded-2xl py-4 order-button"
                >
                    Повторить оплату
                </button>
            </div>
